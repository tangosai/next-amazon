            ...
            <div className="grid gap-x-10 grid-cols-3">
              ...
              <div className="mt-3 col-span-2">
                ...
                <div className="grid grid-cols-2 gap-x-4">
                  ...
                  <div>
                    <ul>
                      <li className="rounded-md p-3 mt-5 border-b-2">
                        <label class="text-sm mb-2 block text-gray-500">
                          Price
                        </label>
                      ...
                      <li className="rounded-md p-3 mt-1 border-b-2">
                        <label class="text-sm mb-2 block text-gray-500">
                          Stock
                        </label>
                      ...
                      <li className="rounded-md p-3 mt-1">
                        <button className="bg-slate-900 w-full h-12 uppercase font-semibold text-white mt-1 rounded-lg">
                          Add to cart
                        </button>
                      </li>
                    </ul>
